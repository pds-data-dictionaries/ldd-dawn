<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:dawn  Version:1.11.0.0 - Tue Sep 01 16:24:06 MST 2020 -->
  ...
  <sch:pattern>
    <sch:rule context="dawn:grand/pds:Local_Internal_Reference">
      <sch:assert test="pds:local_reference_type = ('grand_parameters_to_table')">
        In the grand:GRaND_Parameters class, the attribute pds:reference_type must be equal to 'grand_parameters_to_table'.</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
