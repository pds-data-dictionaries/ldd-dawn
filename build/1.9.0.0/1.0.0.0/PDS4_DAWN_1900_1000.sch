<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:dawn  Version:1.0.0.0 - Wed Nov 14 15:17:30 PST 2018 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:ns uri="http://pds.nasa.gov/pds4/dawn/v1" prefix="dawn"/>
		   ...
		   <!-- ================================================ -->
  <sch:pattern>
    <sch:rule context="dawn:Dawn/dawn:alt_start_time">
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="dawn:Dawn/dawn:alt_stop_time">
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="dawn:Dawn/dawn:callamp_enable_flag">
  ...
  <sch:pattern>
    <sch:rule context="dawn:Dawn/dawn:data_routing_id">
  ...
  <sch:pattern>
    <sch:rule context="dawn:Dawn/dawn:dpu_hardware_id">
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="dawn:Dawn/dawn:fee_flag">
      <sch:assert test=". = ('OFF', 'ON')">
        The attribute dawn:fee_flag must be equal to one of the following values 'OFF', 'ON'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="dawn:Dawn/dawn:fee_hardware_id">
  ...
  <sch:pattern>
    <sch:rule context="dawn:Dawn/dawn:front_dood_status_id">
  ...
  <sch:pattern>
    <sch:rule context="dawn:Dawn/dawn:pcu_hardware_id">
  ...
  <sch:pattern>
    <sch:rule context="dawn:Dawn/dawn:use_pre_clear">
      <sch:assert test=". = ('OFF', 'ON')">
